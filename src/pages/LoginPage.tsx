    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-professional-blue-50 to-growth-teal-50 px-4 pt-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-professional-grey-900">Welcome Back</h1>
          <p className="text-professional-grey-600 mt-2">Sign in to continue your journey</p>
        </div>
        ...
        <Card className="shadow-lg border-0">
          ...
          <CardFooter className="text-center">
            <p className="text-sm text-professional-grey-600">
              ...
              <Link to="/signup" className="text-growth-teal-600 hover:text-growth-teal-700 font-medium">
                Sign up here
              </Link>
            </p>
          </CardFooter>
